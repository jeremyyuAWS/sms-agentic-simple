    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {campaignTypes.map((type) => (
          <Card 
            key={type.id}
            className="cursor-pointer transition-all hover:border-primary hover:shadow-md overflow-hidden group"
          ...
          >
            ...
            <CardHeader className={`pb-2`}>
              <div className={`p-3 rounded-full ${type.bgColor} ${type.color} w-fit mb-2 transition-transform group-hover:scale-110`}>
                {type.icon}
              </div>
            ...
            <CardFooter>
              <Button 
                variant="ghost" 
                className={`w-full justify-start ${type.color} hover:${type.bgColor}`}
              >
